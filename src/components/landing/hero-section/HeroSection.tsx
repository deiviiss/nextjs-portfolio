...
export const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-center px-4 overflow-hidden bg-[#0a0118] dark:bg-[#020817]">
      <div className="fixed flex gap-2 top-0 right-4 z-10 w-full justify-end bg-[#0a0118] dark:bg-[#020817] p-4">
        <Link
      ...
      <div className="container mx-auto max-w-6xl flex flex-col lg:flex-row-reverse items-center gap-4 md:gap-8 md:gap-x-28">
        ...
        <div className="flex flex-col items-center lg:items-start mx-auto text-white">
          <motion.h1
            className="text-6xl md:text-8xl font-bold mb-8 text-center w-full"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
              Desarrollador web Full Stack especializado en NextJs.
      ...
      <motion.div animate={{ y: [0, 10, 0] }} transition={{ repeat: Number.POSITIVE_INFINITY, duration: 1.5 }}>
        <Link
          href="#projects"
          className="flex flex-col items-center text-muted-foreground hover:text-foreground transition-colors text-white"
        >
